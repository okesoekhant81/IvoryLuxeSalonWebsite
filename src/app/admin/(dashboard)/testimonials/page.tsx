        ...
        {(testimonials ?? []).map((t) => (
          ...
          >
            <div className="flex min-w-0 flex-1 items-center gap-4">
              <div className="relative size-12 shrink-0 overflow-hidden rounded-full border border-black/10 bg-black/[0.04]">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-black">
                  ...
                  {!t.published && (
                    <span className="ml-2 rounded-full bg-black/[0.04] px-2 py-0.5 text-xs text-muted">Hidden</span>
                  )}
                </p>
