  ...
  return (
    <section id="services" className="mt-20 scroll-mt-20 md:mt-28">
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        <a
          href="#services"
          className="relative block h-[380px] w-full overflow-hidden rounded-2xl md:h-[460px]"
        >
          <Image
            src={hairService}
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <a href="#services" className="relative block h-[280px] w-full overflow-hidden rounded-2xl md:h-[340px]">
            <Image
              src={nailsService}
